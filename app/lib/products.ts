...
const secondaryMedia: Record<string, ProductMediaSeed[]> = {
  ...
  "hyperx-stinger-2-core": [{ src: "/products/hyperx-cloud-stinger-2-core-2.webp", alt: "Headset HyperX Cloud Stinger 2 Core visto de perfil", sourceUrl: "https://row.hyperx.com/pt/products/hyperx-cloud-stinger-2-core-wired-gaming-headset", sourceLabel: "HyperX", type: "DETAIL" }],
...
export const products: Product[] = [
  ...
  makeProduct({
    id: "hyperx-stinger-2-core", slug: "hyperx-stinger-2-core", brand: "HyperX", model: "Cloud Stinger 2 Core", name: "Headset HyperX Cloud Stinger 2 Core", shortName: "Cloud Stinger 2 Core", category: "Áudio", categorySlug: "audio", productType: "Headset com fio", price: 199.9, pixPrice: 189.91, accent: "#f5ecee", badge: "CONFORTO ESSENCIAL",
